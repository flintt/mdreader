...
图表默认使用“清晰原图”模式，以 1:1 矢量尺寸显示，并在复杂图上提供独立的常驻横向滚动条；也可以点击“适应页面”查看全图。复杂排版测试见 [`examples/mermaid-complex.md`](examples/mermaid-complex.md)。
...
如果图形驱动或窗口初始化失败，程序会显示原生错误对话框，并将具体原因写入 `%LOCALAPPDATA%\\MD Reader\\startup-error.log`。
